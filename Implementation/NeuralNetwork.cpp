...
QVector<NeuralNetwork::Symbol> NeuralNetwork::ReadTrainingData(QString training_data_file)
{
   QVector<NeuralNetwork::Symbol> symbols;
...
QVector<NeuralNetwork::Symbol> NeuralNetwork::ReadTestData(QString test_data_file)
{
   QVector<NeuralNetwork::Symbol> symbols;
